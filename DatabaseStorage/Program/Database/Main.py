...
def graphDatabase_from_TaggedCSV(database, dataframe, propertyToHeader_dict, databaseSchema_dict):
    ...
    def create_issue(row,propertyToHeader_issue):
        ...
        try:
            issue = Issue(problem=row[propertyToHeader_issue['description_problem']],
                          ...
                          databaseInfo=databaseSchema_dict['issue'])
            try:
    ...
    def create_technicians(row, propertyToHeader_technician):
        ...
        try:
            for name in row[propertyToHeader_technician['name']].split(charsplit):
                technicians.append(Technician(name=name, skills=skills, crafts=crafts, databaseInfo=databaseSchema_dict['human']))
        except KeyError:
            pass
    ...
    def create_operators(row,propertyToHeader_operator):
        ...
        try:
            for name in row[propertyToHeader_operator['name']].split(charsplit):
                operators.append(Operator(name=name, databaseInfo=databaseSchema_dict['human']))
        except KeyError:
            pass
    ...
    def create_machine(row, propertyToHeader_machine):
        ...
        try:
            machine = Machine(name=row[propertyToHeader_machine['name']], databaseInfo=databaseSchema_dict['machine'])
    ...
    for index, row in dataframe.iterrows():
        ...
        # print(machine.cypher_machine_type_create_node())

        operators = create_operators(row, propertyToHeader_dict['operator'])
        # print(operators)
        # for operator in operators:
        #     print(operator)
        #     print(operator.cypher_operator_name())
        #     print(operator.cypher_operator_all())
        #     print(operator.cypher_operator_create_node())
        #     print(operator.cypher_human_name())
        #     print(operator.cypher_human_all())
        #     print(operator.cypher_human_create_node())

        technicians = create_technicians(row, propertyToHeader_dict['technician'])
        # print(technicians)
        # for technician in technicians:
        #     print(technician)
        #     print(technician.cypher_technician_name())
        #     print(technician.cypher_technician_all())
        #     print(technician.cypher_technician_create_node())
        #     print(technician.cypher_human_name())
        #     print(technician.cypher_human_all())
        #     print(technician.cypher_human_create_node())


        issue = create_issue(row, propertyToHeader_dict['issue'])
        print(issue)
        # print(issue.cypher_issue_all())
        # print(issue.cypher_issue_create_node())




        # items = create_items(dataframe,namingDict)
        # problems = create_problems(dataframe,namingDict)
        # solutions = create_solutions(dataframe,namingDict)
        # unknowns = create_unknown(dataframe,namingDict)
        # others = create_other(dataframe,namingDict)
